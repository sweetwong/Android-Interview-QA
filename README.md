...
是因为，我是希望将问题的单独化，当面试官问你的时候，并不会说，我准备开始问 Java了，我准备问计算机网络了，他们是会随机抛出一个问题的，因从我们在学习的时候，可以以单个问题为粒度去学习，当你碰到一个随机的面试问题，想想你应该怎么回答。当然系统性的学习也是需要的，这里我比较推荐大家去一些比较成熟的博客或者 Github项目看，我们这个项目并不做系统性的学习整理。
