...
[项目中使用了哪些设计模式？](重要/项目中使用了哪些设计模式？.md)
...
[HTTP常用的首部字段有哪些？](记忆/HTTP常用的首部字段有哪些？.md)

[HTTP有哪些方法？](记忆/HTTP有哪些方法？.md)

[HTTP有哪些状态码？](记忆/HTTP有哪些状态码？.md)

[HTTP的报文结构是怎样的？](记忆/HTTP的报文结构是怎样的？.md)
...
[网络时延有哪些？](记忆/网络时延有哪些？.md)

[虚拟内存技术的实现？](记忆/虚拟内存技术的实现？.md)

[说说HTTPS吧，它和HTTP有什么不同？](记忆/说说HTTPS吧，它和HTTP有什么不同？.md)
...
[LayoutInflater的原理？](普通/LayoutInflater的原理？.md)
...
[计算机网络-Http问题总结](汇总/计算机网络-Http问题总结.md)

[计算机网路-传输层问题总结](汇总/计算机网路-传输层问题总结.md)

[计算机网路-网络层问题总结](汇总/计算机网路-网络层问题总结.md)
...
[动态代理的原理是什么呢？](待整理/动态代理的原理是什么呢？.md)
